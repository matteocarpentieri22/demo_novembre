...
import { AmbulatorioPage } from './types';

interface HomeProps {
  onNavigate: (page: AmbulatorioPage) => void;
}

function Home({ onNavigate }: HomeProps) {
  const menuItems = [
    {
      id: 'visite-giornaliere' as AmbulatorioPage,
      icon: Calendar,
      title: 'Visite Giornaliere',
      description: 'Visualizza le visite programmate per ogni giorno',
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-5 sm:gap-7">
        {menuItems.map((item) => {
