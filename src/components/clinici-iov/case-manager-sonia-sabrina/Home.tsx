...
function Home({ onNavigate }: HomeProps) {
  const menuItems = [
    {
      id: 'triage' as CaseManagerSoniaSabrinaPage,
      icon: ClipboardList,
      title: 'Triage Paziente',
      description: 'Gestisci il triage dei pazienti con caricamento referti',
      color: 'bg-iov-light-blue',
      textColor: 'text-iov-dark-blue-text',
    },
    {
      id: 'elenco-pazienti' as CaseManagerSoniaSabrinaPage,
      icon: Users,
      title: 'Elenco Pazienti',
      description: 'Visualizza e gestisci la documentazione dei pazienti',
      color: 'bg-iov-light-blue',
      textColor: 'text-iov-dark-blue-text',
    },
  ];
