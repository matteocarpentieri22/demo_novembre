  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-2">Selezione PDTA</h2>
              ...
              {selectedData.exams.map((exam, index) => (
                <div key={index} className="flex items-center gap-4">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="bg-white rounded-lg border-2 border-blue-200 px-4 py-3 text-center min-w-[140px]">
                      <p className="text-gray-800 font-medium text-sm">{exam}</p>
                    </div>
                  </div>
                  {index < selectedData.exams.length - 1 && (
                    <ChevronRight className="w-6 h-6 text-blue-600 flex-shrink-0 mb-8" />
                  )}
                </div>
              ))}
            </div>
